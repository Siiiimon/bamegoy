use bamegoy::emulator::disassemble::Operand;
use bamegoy::emulator::{disassemble, util::color32_from_catppuccin_with_alpha};
use egui::{Color32, FontId, TextFormat, text::LayoutJob};
use crate::{COLORS, UiState};
use bamegoy::emulator::{bus::Bus, cpu::CPU, util::color32_from_catppuccin};
